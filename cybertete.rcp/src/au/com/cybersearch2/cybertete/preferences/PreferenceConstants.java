...
{
    public static final String NODEPATH = "au.com.cybersearch2.cybertete";
    public static final String PASSWORD = "password";
    public static final String HOST = "host";
    public static final String PORT = "port";
    public static final String AUTH_CID = "authcid";
    ...
    public static final String KEYSTORE_PASSWORD = "prefs_keystore_password";
}
